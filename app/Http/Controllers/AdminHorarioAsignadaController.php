<?php namespace App\Http\Controllers;
	...
	class AdminHorarioAsignadaController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Hora fin","name"=>"hora_fin"];
			$this->col[] = ["label"=>"Ambiente","name"=>"ambiente_id","join"=>"ambiente,name"];
			$this->col[] = ["label"=>"Estado horario asignada","name"=>"estado_horario_asignada_id","join"=>"estado_horario_asignada,name"];
