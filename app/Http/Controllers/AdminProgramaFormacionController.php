<?php namespace App\Http\Controllers;
	...
	class AdminProgramaFormacionController extends \crocodicstudio\crudbooster\controllers\CBController {

	    public function cbInit() {

			# START CONFIGURATION DO NOT REMOVE THIS LINE
			$this->title_field = "short_name";
			$this->limit = "20";
			$this->orderby = "id,asc";
			...
			$this->col[] = ["label"=>"Abreviatura","name"=>"short_name"];
