<?php namespace App\Http\Controllers;
	...
	class AdminRutaFichaController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->table = "ruta_ficha";
			# END CONFIGURATION DO NOT REMOVE THIS LINE

			# START COLUMNS DO NOT REMOVE THIS LINE
			$this->col = [];
			$this->col[] = ["label"=>"Nombre","name"=>"name"];
			$this->col[] = ["label"=>"Número","name"=>"number"];
			...
			$this->form[] = ['label'=>'Número','name'=>'number','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			...
			//$this->form[] = ["label"=>"Fecha Fin","name"=>"fecha_fin","type"=>"date","required"=>TRUE,"validation"=>"required|date"];
