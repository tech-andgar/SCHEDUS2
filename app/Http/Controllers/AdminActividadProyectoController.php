<?php namespace App\Http\Controllers;
	...
	class AdminActividadProyectoController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Fase","name"=>"fase_id","join"=>"fase,name"];
			...
			//$this->form[] = ["label"=>"Fase Id","name"=>"fase_id","type"=>"select2","required"=>TRUE,"validation"=>"required|integer|min:0","datatable"=>"fase,name"];
			# OLD END FORM
